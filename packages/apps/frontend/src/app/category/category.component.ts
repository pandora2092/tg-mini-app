...
import { Event, City } from '@packages/interfaces';
...
export class CategoryComponent implements OnInit {
  ...
  constructor() {
    ...
    this.list = [
      ...
      {
        id: 2,
        name: this.currentMonthString,
        isChosen: false,
        func: this.clickCurrentMonthHandler.bind(this),
      },
      {
        id: 3,
        name: this.nextMonthString,
        isChosen: false,
        func: this.clickNextMonthHandler.bind(this),
      },
    ];
  }
  ...
  getAllEventsByCategories(
    ...
    this.isLoading = true;
    this.eventsService
      .getAllEventsByCategories(city, category, page, pageSize, actualSince, actualUntil)
      .subscribe((events) => {
